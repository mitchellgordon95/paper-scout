...
function RulesModal({isOpen, onClose}) {
  return (
    <Modal isOpen={isOpen}>
      <Flexbox flexDirection='row' alignItems='flex-start' justifyContent='flex-end'>
      ...
      6th paper, you must drop one of your existing endorsements (and
      therefore stop collecting points from it).</p>

      <p>As long as your endorsement is on a paper, you get a point for every other person who endorses that paper.</p>
